...
RCFILE='k8resources/pttg-family-migration-ui-rc.yaml'
RCTIMEOUT='5m'
...
SVCFILE='k8resources/pttg-family-migration-ui-svc.yaml'
...
function svc(){
  local SVC_NODE_PORT=`grep pttg_income_proving_ui_port "${SVC_NODE_PORT_FILE}" | awk '{print $2}'`
  # typecasting in bash
